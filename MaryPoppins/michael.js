function buttonClick(id, step){
	switch(step){
		...
		case "step1":
			switch(id){
				case "buttonA":
					...
					document.getElementById("optionB").innerHTML = "stubbornly refuse as you are rather inclinded to do?";
					...
					break;
				case "buttonB":
					document.getElementById("info").innerHTML = "You specifically requested 'No warts'.  Your adventure is over.";
					document.getElementById("optionA").innerHTML = "Play Again";
					document.getElementById("optionB").hidden = true;
					document.getElementById("optionC").hidden = true;
					document.getElementById("buttonA").onclick = function() {window.location.href = 'index.html'};
					...
					break;
				case "buttonC":
					document.getElementById("info").innerHTML = "You specifically put in the part about not smelling of barley water.  Your adventure is over.";
					document.getElementById("optionA").innerHTML = "Play Again";
					document.getElementById("optionB").hidden = true;
					document.getElementById("optionC").hidden = true;
					document.getElementById("buttonA").onclick = function() {window.location.href = 'index.html'};
		...
		case "step2":
			switch(id){
				case "buttonA":
					...
					break;
				case "buttonB":
					document.getElementById("info").innerHTML = "Perhaps if you weren't so suspicious you would have already taken the time to tidy up the nursery.  Your adventure is over.";
					document.getElementById("optionA").innerHTML = "Play Again";
					document.getElementById("optionB").hidden = true;
					document.getElementById("optionC").hidden = true;
					document.getElementById("buttonA").onclick = function() {window.location.href = 'index.html'};
				...
				case "buttonC":
					...
					document.getElementById("optionC").innerHTML = "refuse your strawberry medicine?";
		...
		case "step3":
			switch(id){
				case "buttonA":
					...
					break;
				case "buttonB":
					document.getElementById("info").innerHTML = "After getting a proper night's sleep you and your sister are off to the bank today.  Would you like to...";
		...
		case "step4":
			switch(id){
				case "buttonA":
					document.getElementById("info").innerHTML = "Father may feel that you've got nothing to show but fat birds but he will come around. Back at the house you pass the time helping Bert with the chimney sweeping when a sudden gust tugs at the broom.  Would you like to...";
					document.getElementById("optionA").innerHTML = "run away, after all you never known what may happen around a fireplace?";
					document.getElementById("optionB").innerHTML = "hang on for dear life and see where it leads?";
					document.getElementById("optionC").innerHTML = "let go of the broom as it is pulled up the chimney?";
		...
		case "step5":
			switch(id){
				case "buttonA":
					document.getElementById("info").innerHTML = "While Bert goes after the errant broom you are alone in the house and taken by the Hottentots.  Your adventure is over.";
					document.getElementById("optionA").innerHTML = "Play Again";
					document.getElementById("optionB").hidden = true;
					document.getElementById("optionC").hidden = true;
					document.getElementById("buttonA").onclick = function() {window.location.href = 'index.html'};
					...
					break;
				case "buttonB":
					document.getElementById("info").innerHTML = "YOU WIN! You are swept up the chimney and you feel as though you've passed through a doorway to world of enchantment only seen by the birds, the stars, and the chimney sweeps. When father returns home the next day he has mended your kite and wants to take you to the park.";
					document.getElementById("optionA").innerHTML = "Play Again";
					document.getElementById("optionB").hidden = true;
					document.getElementById("optionC").hidden = true;
					document.getElementById("buttonA").onclick = function() {window.location.href = 'index.html'};
